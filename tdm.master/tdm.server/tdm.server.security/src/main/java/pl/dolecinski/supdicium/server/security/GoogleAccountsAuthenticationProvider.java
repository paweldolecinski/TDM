...
import pl.dolecinski.supdicium.server.users.GaeUser;
import pl.dolecinski.supdicium.server.users.UserRegistry;
...
public class GoogleAccountsAuthenticationProvider implements
	...
	public Authentication authenticate(Authentication authentication)
		...
		if (user == null) {
			...
			user = new GaeUser(googleUser.getUserId(),
	...
	public final boolean supports(Class<?> authentication) {
		return PreAuthenticatedAuthenticationToken.class
				...
				|| GaeUserAuthentication.class.isAssignableFrom(authentication);
	}
