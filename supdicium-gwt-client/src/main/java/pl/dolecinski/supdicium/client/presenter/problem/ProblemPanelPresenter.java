 ...
 * 
 */
public class ProblemPanelPresenter extends
		Presenter<ProblemPanelPresenter.Display, ProblemPanelPresenter.IProxy> {
	...
	@ProxyCodeSplit
	public interface IProxy extends ProxyPlace<ProblemPanelPresenter> {
	}
	...
	@Inject
	public ProblemPanelPresenter(EventBus eventBus, Display view, IProxy proxy,
