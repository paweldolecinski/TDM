...
//
///**
// * A panel that uses the HTML UL element. All children will be wrapped into LI
// * elements.
// * 
// * Using UL lists is a modern pattern to layout web pages, as it is easy to
// * style them with CSS. Moreover, they have several advantages over tables
// * (changing the layout requires changing the code, accessibility, etc).
// * 
// * @author Markus
// */
...
////			setStyleName(SupDiciumDesktopApp.getResources().common().uiListItem());
//		}
//
//		/**
//		 * Adds a new child widget to the panel.
