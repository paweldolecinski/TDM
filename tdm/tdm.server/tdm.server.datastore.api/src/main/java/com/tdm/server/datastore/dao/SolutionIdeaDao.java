...
public interface SolutionIdeaDao {
	...
	SolutionIdea create(long problemId, String solutionIdeaName);

	SolutionIdea read(long problemId, long solutionIdeaId) throws ObjectNotFoundException;
	 ...
	 */
	void update(SolutionIdea soultionIdea) throws ObjectNotFoundException,
	...
	Collection<SolutionIdea> findAllAssignedTo(long problemId);
