 ...
 * what you want and
 * {@link #update(com.tdm.common.dto.Problem)
...
public interface ProblemDao {
	...
	Problem create(String name, String description);

	Problem create(String userName, String title, String description);

	Problem read(long id) throws ObjectNotFoundException;

	/**
	 * Updates request with values taken from given {@link Problem}. If
	 ...
	 */
	void update(Problem request) throws ObjectNotFoundException,
	...
	Collection<Problem> findAllAssignedTo(long expertId);

	Collection<Problem> findAllAssignedTo(long expertId, String expertRole);
