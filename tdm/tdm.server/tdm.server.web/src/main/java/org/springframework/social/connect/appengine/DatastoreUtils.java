...
public class DatastoreUtils {
	...
	public static <T> List<T> queryForList(PreparedQuery pq,
			EntityMapper<T> entityMapper) {
		return queryForList(pq, FetchOptions.Builder.withDefaults(),
				entityMapper);
	}

	public static <T> List<T> queryForList(PreparedQuery pq,
			FetchOptions fetchOptions, EntityMapper<T> entityMapper) {
	...
	public static <T> Map<Key, T> queryForMap(PreparedQuery pq,
			EntityMapper<T> entityMapper) {
	...
	public static String createConnectionKeyName(String userId,
		...
		StringBuilder sb = new StringBuilder(connectionKey.getProviderId())
				...
				.append(connectionKey.getProviderUserId());
		return sb.toString();
	}
